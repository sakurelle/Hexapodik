...
Временные тестовые значения для всех 18 серв:
...
Тесты проверяют преобразование углов в импульсы, возрастающую и убывающую калибровку, ограничение диапазонов, CRC32, magic/version конфигурации, разбор UART-команд и построение фазового расписания.
