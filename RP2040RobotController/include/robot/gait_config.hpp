...
constexpr float GAIT_LIFT_FEMUR_DELTA_DEG = 8.0f;
constexpr float GAIT_LIFT_TIBIA_DELTA_DEG = -8.0f;
constexpr float GAIT_COXA_SWING_DEG = 8.0f;
...
constexpr bool AUTO_DEMO_GAIT_ON_BOOT = true;
...
constexpr float forwardCoxa(servo::Leg leg) {
    return GAIT_COXA_SWING_DEG * COXA_FORWARD_SIGN[servo::leg_index(leg)];
}
